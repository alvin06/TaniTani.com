...
<body>
        ...
        <div class="span9">
          ...
          <div class="navbar navbar-inverse">
              <div class="navbar-inner">
                  ...
                  <li><form method="post" action="searchalat.php">
  ...
  $halaman = 3;
    ...
    $result = mysqli_query($conn,"SELECT * FROM items WHERE category='Alat Tani' And items_name LIKE '%".$term."%'  ORDER BY id_items ");
    $total = mysqli_num_rows($result);
    $pages = ceil($total/$halaman);
    $sql = mysqli_query($conn, "SELECT * FROM items WHERE category='Alat Tani'and items_name LIKE '%".$term."%'  ORDER BY id_items DESC LIMIT $mulai, $halaman");
