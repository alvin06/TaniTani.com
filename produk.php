...
<body>
			    		...
			    		<div class="navbar-inner">
			          		...
			          		<div class="nav-collapse collapse">
			            		<ul class="nav">
									...
									<li><form method="post" action="searchproduk.php">
	...
	<div id="page-title">
		...
		<div id="page-title-inner">
			...
			<div class="container">
				...
				<h2><i class="ico-stats ico-white"></i>Produk Pertanian</h2>
	...
	<div>
        ...
        <h2><b><center>Alat Tani Terbaru</center></b></h2>
        <hr size="5px" width="100%" color="#32CD32">
  </div>
	<!--start: Wrapper-->
	<div id="wrapper">
	...
	$halaman = 3;
  	...
  	$result = mysqli_query($conn,"SELECT * FROM items where category= 'Alat Tani' ORDER BY id_items DESC ");
  	$total = mysqli_num_rows($result);
  	$pages = ceil($total/$halaman);
    $sql = mysqli_query($conn, "SELECT * FROM items  where category= 'Alat Tani' ORDER BY id_items DESC LIMIT $mulai, $halaman ");
		...
		while($data = mysqli_fetch_assoc($sql)){
        		...
        		<div class="span4">
          			<div class="icons-box">
						...
						<div><h3>Rp.<?php echo number_format($data['price'],2,",",".");?></h3></div>
					<!--	<p>
...
<!---->			
			...
			<!-- end: Row -->
					 <center>
        		<h3><a href="Alat.php">Alat Tani lainnya</a></h3>
     				 </center>
			 </div>
 ...
 <div>
          <hr size="5px" width="100%" color="#32CD32">
          <h2><b><center>Hasil Tani Terbaru</center></b></h2>
          <hr size="5px" width="100%" color="#32CD32">
    </div>
		<!--end: Container-->
				 <!--start: Container -->
    ...
    $halaman = 3;
  	$page = isset($_GET["halaman"]) ? (int)$_GET["halaman"] : 1;
  	$mulai = ($page>1) ? ($page * $halaman) - $halaman : 0;
  	$result = mysqli_query($conn,"SELECT * FROM items WHERE category = 'Hasil Tani' ORDER BY id_items DESC ");
  	$total = mysqli_num_rows($result);
  	$pages = ceil($total/$halaman);
    $sql = mysqli_query($conn, "SELECT * FROM items WHERE category = 'Hasil Tani' ORDER BY id_items DESC LIMIT $mulai, $halaman");
	if(mysqli_num_rows($sql) == 0){
		echo "Tidak ada produk!";
	}else{
		while($data = mysqli_fetch_assoc($sql)){
...
<!---->			
			...
			<!-- end: Row -->
				<center>
        <h3><a href="hasil.php">Hasil Tani lainnya</a></h3>
      </center>	
        <!-- end: Row -->
          </div>
          </div>
