...
<body>
  ...
  $halaman = 3;
    ...
    $result = mysqli_query($conn,"SELECT * FROM article WHERE title LIKE '%".$term."%'  ORDER BY id_article ");
    $total = mysqli_num_rows($result);
    $pages = ceil($total/$halaman);
    $sql = mysqli_query($conn, "SELECT * FROM article WHERE title LIKE '%".$term."%'  ORDER BY id_article DESC LIMIT $mulai, $halaman");
