...
<body>
        ...
        <div class="span9">
          ...
          <div class="navbar navbar-inverse">
              <div class="navbar-inner">
                  ...
                  <li><form method="post" action="searchforumhasil.php">
  ...
  <div>
        ...
        <h2><b><center>Hasil Pencarian Forum Hasil Tani</center></b></h2>
        <hr size="5px" width="100%" color="#32CD32">
  </div>
  <!--start: Wrapper-->
  <div id="wrapper">
  ...
  $halaman = 3;
    ...
    $result = mysqli_query($conn,"SELECT * FROM article WHERE category='Hasil Tani' and title LIKE '%".$term."%'  ORDER BY id_article ");
    $total = mysqli_num_rows($result);
    $pages = ceil($total/$halaman);
    $sql = mysqli_query($conn, "SELECT * FROM article WHERE category ='Hasil Tani' and title LIKE '%".$term."%'  ORDER BY id_article DESC LIMIT $mulai, $halaman");
