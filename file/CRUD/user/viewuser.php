                            ...
                            <div class="nav-collapse collapse">
                                <ul class="nav">
                                    ...
                                    echo '<li class="dropdown">
                                        ...
                                        <a href="#" class="dropdown-toggle" data-toggle="dropdown"> <b class="caret"></b></a>
                                        <ul class="dropdown-menu">
                                            <li><a href="file/interface/login/login.php">Login</a></li>
...
<!-- jual beli -->
    ...
    <div id="page-title">
        ...
        <div id="page-title-inner">
            ...
            <!-- start: Container -->
            <div class="container">
                <h2><i class="ico-user ico-white"></i><?php echo $hasil['username'];?></h2>
                </div>
            <!-- end: Container  -->
 ...
 <div class="container">
      ...
      <div class="col-md-5  toppad  pull-right col-md-offset-3 ">
          <?php 
          if($id==$hasil['id_user']||$idadmin=='1'){
          echo "<a href='../../interface/page/editprofile.php?id_user=".$hasil['id_user']."'>Edit Profile</a>";
          }?>
        ...
        <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6 col-xs-offset-0 col-sm-offset-0 col-md-offset-3 col-lg-offset-3 toppad" >
          ...
          <div class="panel panel-info">
            ...
            <div class="panel-body">
              ...
              <div class="col-md-3 col-lg-3 " align="center">  <?php echo "<img src='images/".$hasil['user_picture']."' width='100' height='100' >";?></div>
