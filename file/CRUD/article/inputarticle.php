			            		...
			            		<ul class="nav">
									...
									echo '<li class="dropdown">
			                			...
			                			<ul class="dropdown-menu">
                                            <li><a href="../../interface/page/profile.php">Profil</a></li>
			                  				<li><a href="../../interface/page/logout.php">Keluar</a></li>
			                			</ul>
			              			</li>'; 
			            			}
 ...
 <div class="container">
      <div class="row">
		...
		<tr>
			<td>Kategori</td>
				<td>
   					 <input type="radio" name="category" value="Hasil Tani" required> Hasil Tani
    				 <input type="radio" name="category" value="Sharing Pertanian" required> Sharing Pertanian
    				 <input type="radio" name="category" value="Alat Tani" required> Alat Tani
    			</td>
		</tr>
		<!-- <tr>
			<td>Description</td>
		...
		<center><button class="btn btn-lg btn-success" type="submit">Buat</button></center>
