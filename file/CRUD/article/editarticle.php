    ...
    <div class="container">
      ...
      <div class="row">
        ...
        <div class="logo span3">
          ...
          <a class="brand" href="postlogin_homepage.php"><img src="img/logotanifixbgt.png" alt="Logo"></a>
        </div>
        <!--end: Logo -->
              ...
              <div class="navbar-inner">
                  ...
                  echo '<li class="dropdown">
                            ...
                            <ul class="dropdown-menu">
                                            <li><a href="../../interface/page/profile.php">Profile</a></li>
                                <li><a href="../../interface/page/logout.php">Logout</a></li>
                            </ul>
                          </li>'; 
                        }
                            ...
                            <ul class="dropdown-menu">
                                            ...
                                            <li><a href="../daftar/daftar.php">Sign Up</a></li>
                            </ul>
                          </li>'; 
...
<!-- jual beli -->
 ...
 <div class="container">
  ...
  <tr>
    <td>Category</td>
    <?php
    if($data['category'] == "Hasil Tani"){
      echo"<td>";
      echo "<input type='radio' name='category' value='Hasil Tani' checked='checked'> Hasil Tani";
      echo "<input type='radio' name='category' value='Sharing Pertanian'> Sharing Pertanian";
      echo "<input type='radio' name='category' value='Alat Tani'> Alat Tani";
      echo"</td>";
    }else if($data['category'] == "Sharing Pertanian"){
      echo"<td>";
      echo "<input type='radio' name='category' value='Hasil Tani' > Hasil Tani";
      echo "<input type='radio' name='category' value='Sharing Pertanian' checked='checked'> Sharing Pertanian";
      echo "<input type='radio' name='category' value='Alat Tani'> Alat Tani";
      echo"</td>";
    }
    else
      {
        ...
        echo "<input type='radio' name='category' value='Hasil Tani' > Hasil Tani";
      echo "<input type='radio' name='category' value='Sharing Pertanian' > Sharing Pertanian";
      echo "<input type='radio' name='category' value='Alat Tani' checked='checked'> Alat Tani";
        echo"</td>";
        }
        ?>
  </tr>
