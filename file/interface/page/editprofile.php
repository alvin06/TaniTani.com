		...
		<div class="container">
			...
			<div class="row">
				...
				<div class="logo span3">
					...
					<a class="brand" href="../../interface/page/postlogin.php"><img src="img/logotanifixbgt.png" alt="Logo"></a>
				</div>
				<!--end: Logo -->
        ...
        <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6 col-xs-offset-0 col-sm-offset-0 col-md-offset-3 col-lg-offset-3 toppad" >
          ...
          <div class="panel panel-info">
            ...
            <div class="panel-body">
              <div class="row">
                <div class="col-md-3 col-lg-3 " align="center">  <?php echo "<img src='../../CRUD/user/images/".$data['user_picture']."' width='100' height='100' >";?></div>
                ...
                <div class=" col-md-9 col-lg-9 ">
                 <form method="post" action="../../CRUD/user/editprocessuser.php?id_user=<?php echo $id_user; ?>" enctype="multipart/form-data" >
                  <table class="table table-condensed">
    					...
    					<td>Kata Sandi</td>
  						...
  						<tr>
    						...
    						<?php
		    						if($data['sex'] == "Male"){
		    							echo "<td>";
		      								echo "<input type='radio' name='sex' value='Male' checked='checked'> Pria";
		      								echo "<input type='radio' name='sex' value='Female'> Wanita";
		      								echo"</td>";
		    						}else{
		    							echo "<td>";
		      								echo "<input type='radio' name='sex' value='Male'> Pria";
		      								echo "<input type='radio' name='sex' value='Female' checked='checked'> Wanita";
		    							echo "</td>";
		    						}?>
  						</tr>
  						<tr>
                    ...
                    <center><button class="btn btn-lg btn-danger" type="submit">Ganti</button></center>
                </form>
