		...
		<div class="container">
			...
			<div class="row">
				...
				<div class="logo span3">
					...
					<a class="brand" href="postlogin.php"><img src="img/logotanifixbgt.png" alt="Logo"></a>
				</div>
				<!--end: Logo -->
...
<!-- jual beli -->
 ...
 <div class="container">
      ...
      <div class="col-md-5  toppad  pull-right col-md-offset-3 ">
          <?php echo "<a href='editprofile.php?id_user=".$hasil['id_user']."'>Ganti Profil</a>";?>
       <br>
      </div>
        <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6 col-xs-offset-0 col-sm-offset-0 col-md-offset-3 col-lg-offset-3 toppad" >
          ...
          <div class="panel panel-info">
            ...
            <div class="panel-body">
              ...
              <div class="col-md-3 col-lg-3 " align="center">  <?php echo "<img src='../../CRUD/user/images/".$hasil['user_picture']."' width='100' height='100' >";?></div>
