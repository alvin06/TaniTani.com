  ...
  $username = $result1['username'];?>
	...
	<div id="wrapper">
		...
		<div class="container">
			...
			<!-- start: Table -->
            <div class="title"><h3> Penulis : <?php echo "<a href='file/CRUD/user/viewuser.php?id_user=".$result1['id_user']."'>".$result1['username']."</a>";?></h3></div>
...
$queryartikel = "SELECT * FROM article WHERE id_article='".$ida."'";
  ...
  echo "<td>".$data['category']."</td>";
    echo "<td><img src='file/CRUD/article/images/".$data['article_picture']."' width='100' height='100'></td>";
    echo "<td>".$data['content']."</td>";
  if($id==$data['id_user']||$idadmin=='1'){
    echo "<td><a href='file/CRUD/article/editarticle.php?id_article=".$data['id_article']."'>Edit</a></td>";
    echo "<td><a href='file/CRUD/article/deletearticle.php?id_article=".$data['id_article']."'>Delete</a></td>";
    echo "</tr>";
    }
  else{
    echo "</tr>";
  ...
  while($komen = mysqli_fetch_array($querykomen)){ // Ambil semua data dari hasil eksekusi $sql
    ...
    echo "<td><a href='file/CRUD/article/deletecomment.php?id=".$komen['id_comment']."'>Delete</a></td>";
    echo "</tr>";
    }
  else{
    echo "</tr>";
  ...
  <form name="create" action="file/CRUD/article/inputprocesscomment.php?id_article=<?php echo $id_article; ?>" method="POST">
