...
<body>
  ...
  <div>
        ...
        <h2><b><center>Hasil pencarian</center></b></h2>
        <hr size="8px" width="100%" color="#32CD32">
  </div>
  <!--start: Wrapper-->
  <div id="wrapper">
  ...
  $halaman = 3;
    ...
    $result = mysqli_query($conn,"SELECT * FROM items WHERE items_name LIKE '%".$term."%'  ORDER BY id_items ");
    $total = mysqli_num_rows($result);
    $pages = ceil($total/$halaman);
    $sql = mysqli_query($conn, "SELECT * FROM items WHERE items_name LIKE '%".$term."%'  ORDER BY id_items DESC LIMIT $mulai, $halaman");
