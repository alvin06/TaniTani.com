					...
					<div class="navbar navbar-inverse">
			    		<div class="navbar-inner">
			          		...
			          		<div class="nav-collapse collapse">
			            		<ul class="nav">
			              			<li><a href="file/interface/daftar/daftar.php"><span class="glyphicon glyphicon-user">Sign Up</span></a></li>
			              			<li><a href="file/interface/login/login.php"><span class="glyphicon glyphicon-log-in">Log In</a></li>
									<!-- dropdown
									<li class="dropdown">
...
<!-- jual beli -->
	...
	<a href="file/CRUD/items/inputitems.php">Jual Produk</a>
	<!-- end: Page Title -->
  ...
  <div id="wrapper">
	...
	<?php
		$limit=3;
        $sql = mysqli_query($conn, "SELECT * FROM items ORDER BY id_items DESC LIMIT $limit WHERE category =Alat Tani");
		while($data = mysqli_fetch_array($sql)){
                    ?>
        		<div class="span4">
          			<div class="icons-box">
                        <div class="title"><h3><?php echo $data['items_name']; ?></h3></div>
                        <img src="<?php echo $data['items_picture']; ?>" />
						<div><h3>Rp.<?php echo number_format($data['price'],2,",",".");?></h3></div>
					<!--	<p>

						</p> -->
						<div class="clear"><a href="detailproduk.php?id_items=<?php echo $data['id_items'];?>" class="btn btn-lg btn-danger">Detail</a> </div>
=
                    </div>
        		</div>
                <?php
...
<!---->
			...
			<!--end: Row-->
    <div class="center">
      <h3><a href="alat.php" value = "Alat Tani">Alat Tani lainnya</a></h3>
    </div>
    <!--end: Container-->
<!-- Akhir Jual Beli -->
